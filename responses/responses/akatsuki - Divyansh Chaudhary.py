...
def logic(arena_data: dict):
    ...
    if count_ground > count_air:
        recommended_counter = "ground"    # Counter ground with air units.
    elif count_air > count_ground:
        recommended_counter = "air" # Counter air with ground units.
    else:
    ...
    troop_data = {
        ...
        Troops.archer:    {"score": 3, "category": "ground", "name": "Archer"},
        Troops.prince:     {"score": 4, "category": "ground", "name": "Prince"},
        Troops.dragon:    {"score": 4, "category": "air",    "name": "Dragon"},
